        ...
        <nav role="navigation" class="nav-main">
            <ul class="clearfix list-nostyle">
                ...
                if(isset($_SESSION['sabilulungan']['role'])){
                    ...
                    elseif($_SESSION['sabilulungan']['role']==9) echo '<li><a class="link-purple" href="'.site_url('report').'">Koreksi</a></li><li><a class="link-purple" href="'.site_url('cms').'">CMS</a></li> ';
                }else echo '
                    <li>
                        <a class="link-purple" href="'.site_url('peraturan').'">Peraturan</a>
                    </li> 
                    <li>
                        <a class="link-green" href="'.site_url('statistik').'">Statistik</a>
                    </li>
                    ';
                ?> 
            </ul>
