...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        <h1 class="page-title page-title-border">Konfirmasi Kode</h1>
        <?php
        ...
        ?>        
        <form class="form-global" method="post" action="<?php echo site_url('/confirm') ?>">
            <fieldset>
                ...
                <div class="control-actions clearfix">
                    ...
                    <a class="btn-black btn-plain btn" href="<?php echo site_url('/resend') ?>"target="_blank">Kirim ulang kode</a>
                </div>
            </fieldset>
        </form>
        <!-- form-register -->
